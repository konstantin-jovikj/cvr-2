        ...
        <div class="mt-4 flex w-full gap-4">
            ...
            <div class="w-1/2">
                ...
                <div class="mt-4">
                    ...
                    <textarea wire:model="locDepDesc" name="locDepDesc" id="locDepDesc" rows="6" required autocomplete="locDepDesc" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm"></textarea>
