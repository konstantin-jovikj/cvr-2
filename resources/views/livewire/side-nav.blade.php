<div class="sidebar  top-0 bottom-0 lg:left-0 p-2 w-[300px] overflow-y-auto text-center bg-gray-900">
    ...
    <div class="text-left text-xs mt-2 w-4/5 mx-auto text-gray-200 font-bold " id="userSubmenu">
        <a wire:navigate href="/users" class="cursor-pointer p-2 hover:bg-sky-600 rounded-md mt-1 bg-gray-800 block">
            Корисници
        </a>
        <a wire:navigate href="/roles" class="cursor-pointer p-2 hover:bg-sky-600 rounded-md mt-1 bg-gray-800 block"
            href="#">
            Улоги (Roles)
        </a>
