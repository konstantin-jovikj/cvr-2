...
class RelateddocumentsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Relateddocuments::create([
            'desc' => 'Фотокопија од потврдата за сообразност за ЕУ одобрување на возилото- Certificate of conformity (за ново или половно возило), издаден од непосредниот производител на возилото – COC, со оригинал за увид или други документи со кои се потврдува дека возилото е од одобрен тип во Република Северна Македонија',
        ]);
    }
}
